...
2. Destination cache service (Redis → PostgreSQL → Gemini)
...
8. TripAdvisor intel service (Content API: top spots, ratings, sentiment)
9. Background prefetch endpoint (fire-and-forget)
10. Transport options endpoint
...
- `src/services/external/tripadvisor.ts`
